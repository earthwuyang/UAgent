        ...
        if hasattr(result, "usage"):
            token_tracker.add_tokens(
                ...
                (
                    ...
                    and hasattr(result.usage.completion_tokens_details, "reasoning_tokens")
                    else 0
                ),
                (
                    result.usage.prompt_tokens_details.cached_tokens
                    if hasattr(result.usage, "prompt_tokens_details")
                    and result.usage.prompt_tokens_details is not None
                    and hasattr(result.usage.prompt_tokens_details, "cached_tokens")
                    else 0
                ),
            )
