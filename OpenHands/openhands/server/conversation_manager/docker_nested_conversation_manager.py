...
class DockerNestedConversationManager(ConversationManager):
    ...
    async def _create_runtime(
        ...
        # Don't set WORKSPACE_BASE to avoid hardcoded absolute paths that don't work across platforms
        # The workspace will be auto-created by the runtime in a platform-independent location
        # env_vars['WORKSPACE_BASE'] = '/workspace'  # Commented out to avoid hardcoded path
