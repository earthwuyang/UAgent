...
#define CONFIGURE_ARGS " '--prefix=/workspace/postgresql'"
...
#define PG_VERSION_STR "PostgreSQL 15.4 on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14+deb12u1) 12.2.0, 64-bit"
